...
describe('AuthHealthMonitor', () => {
  ...
  describe('Health Status Assessment', () => {
    ...
    it('should return warning status with minor issues', () => {
      ...
      // Record some minor issues
      monitor.recordPollingEvent(false, 0, new Error('Minor polling error'));
      monitor.recordCallbackEvent(false, 10, new Error('Callback error'));
    ...
    it('should return critical status with severe issues', () => {
      ...
      // Record critical storage errors
      for (let i = 0; i < 3; i++) {
  ...
  describe('Cleanup and Reset', () => {
    ...
    it('should cleanup resources on destroy', () => {
      ...
      // Should have emitted destroy alert
      expect(alertCallback).toHaveBeenCalledWith(
        expect.objectContaining({
          level: 'info',
