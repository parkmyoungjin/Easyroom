...
describe('DeploymentUpdateNotification', () => {
  ...
  it('should render notification when deployment info is available', () => {
  ...
  it('should show environment info for non-production environments', () => {
  ...
  it('should call onUpdate callback when deployment info is received', () => {
  ...
  it('should handle force check button click in development', () => {
    const originalEnv = process.env.NODE_ENV;
    process.env.NODE_ENV = 'development';
...
describe('useDeploymentUpdateNotification', () => {
  ...
  it('should update state when deployment info is received', () => {
    (deploymentIntegration.addUpdateListener as jest.Mock).mockImplementation((callback) => {
      setTimeout(() => callback(mockDeploymentInfo), 0);
    });
  ...
  it('should dismiss update when dismissUpdate is called', () => {
    (deploymentIntegration.addUpdateListener as jest.Mock).mockImplementation((callback) => {
      setTimeout(() => callback(mockDeploymentInfo), 0);
    });
