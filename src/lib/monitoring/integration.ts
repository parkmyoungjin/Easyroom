...
import { securityMonitor, recordAuthFailure, recordSuspiciousAccess, recordPrivilegeEscalationAttempt } from './security-monitor';
import { performanceMonitor, measureAuthentication, measureAuthorization, measureDatabaseQuery } from './performance-monitor';
