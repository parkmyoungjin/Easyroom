# 아키텍처 통일성 검증을 위한 코드 자료

---

## 1. 데이터베이스 전체 스키마

### `supabase/migrations/20250802093533_remote_schema.sql`
...
-- ✅ RPC 함수 4: 공개 예약 목록 조회 (페이지네이션 지원)
...
-- ✅ RPC 함수 5: 사용자 예약 상세 조회 (페이지네이션 지원)
...
-- ✅ RPC 함수 7: updated_at 컬럼 업데이트 (트리거 함수)
...
### `src/hooks/useReservations.ts` (useReservationStatistics)
...
### `src/hooks/useRooms.ts` (useAdvancedRoomSearch)
